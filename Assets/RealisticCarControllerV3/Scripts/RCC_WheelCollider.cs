...
public class RCC_WheelCollider : RCC_Core {
    ...
    float originalFStiffness;
    float originalSStiffness;
    public float maxFricLossMult =0.9f;
    ...
    private void Start() {
        ...
        originalFStiffness = wheelCollider.forwardFriction.stiffness;
        originalSStiffness = wheelCollider.sidewaysFriction.stiffness;
    }
    ...
    private void Frictions() {
        ...
        forwardFrictionCurve.stiffness = RCC_GroundMaterials.Instance.frictions[groundIndex].forwardStiffness* (1-hit.sidewaysSlip*maxFricLossMult);
        sidewaysFrictionCurve.stiffness = (RCC_GroundMaterials.Instance.frictions[groundIndex].sidewaysStiffness * (1 - hit.forwardSlip * maxFricLossMult));
